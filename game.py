...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_evaluator_games", type=int, default=10, help="No of games to play to evaluate neural nets")
    ...
    evaluate_nets(args, iteration_1=1, iteration_2=2)
